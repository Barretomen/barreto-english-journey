...
function demoItem(
  ...
  const levelPosition = ['A1', 'A2', 'B1', 'B2', 'C1', 'C2'].indexOf(levelCode) + 1
  const moduleId = ((levelPosition - 1) * 2) + moduleNumber
  return {
    id,
    externalId: `${levelCode}-${String(levelLessonNumber).padStart(2, '0')}`,
    levelCode,
    levelPosition,
    moduleId,
    moduleExternalId: `${levelCode}-M${moduleNumber}`,
    moduleTitle,
    moduleNumber,
    levelLessonNumber,
    moduleLessonNumber,
    ...
    title,
    summary,
    state: id === 1 ? 'current' : 'locked',
    isCheckpoint,
    progressPercent: id === 1 ? 18 : 0,
  }
}

const journey: LessonCatalogItem[] = [
  demoItem(1, 'A1', 1, 1, 1, 'A1.1 · First Steps', 'Hello!', 'Cumprimentos para começar conversas.'),
  demoItem(2, 'A1', 2, 1, 2, 'A1.1 · First Steps', 'Me and My Family', 'Família e apresentações.'),
  demoItem(3, 'A1', 3, 1, 3, 'A1.1 · First Steps', 'My Everyday Life', 'Rotina, horas e frequência.'),
  demoItem(4, 'A1', 4, 1, 4, 'A1.1 · First Steps', 'Things Around Me', 'Casa, objetos e posições.'),
  demoItem(5, 'A1', 5, 1, 5, 'A1.1 · First Steps', 'Checkpoint A1.1', 'Revisão do primeiro ciclo.', true),
  demoItem(6, 'A1', 6, 2, 1, 'A1.2 · Everyday English', 'Food & Drinks', 'Pedidos, alimentos e quantidades.'),
  demoItem(7, 'A1', 7, 2, 2, 'A1.2 · Everyday English', 'What Are You Doing?', 'Ações acontecendo agora.'),
  demoItem(8, 'A1', 8, 2, 3, 'A1.2 · Everyday English', 'Can You Help Me?', 'Habilidades, pedidos e direções.'),
  demoItem(9, 'A1', 9, 2, 4, 'A1.2 · Everyday English', 'A1 Final', 'Projeto e checkpoint A1.', true),
  demoItem(10, 'A2', 1, 1, 1, 'A2.1 · Expanding Stories', 'The Past', 'Primeiras histórias no passado.'),
  demoItem(11, 'A2', 2, 1, 2, 'A2.1 · Expanding Stories', 'Stories and Experiences', 'Sequência e storytelling.'),
  demoItem(12, 'A2', 3, 1, 3, 'A2.1 · Expanding Stories', 'Plans and the Future', 'Planos, viagens e futuro.'),
  demoItem(13, 'A2', 4, 1, 4, 'A2.1 · Expanding Stories', 'Comparing Things', 'Comparações e superlativos.'),
  demoItem(14, 'A2', 5, 1, 5, 'A2.1 · Expanding Stories', 'Checkpoint A2.1', 'Revisão do primeiro ciclo A2.', true),
  demoItem(15, 'A2', 6, 2, 1, 'A2.2 · Real Conversations', 'Life Experiences', 'Experiências de vida.'),
  demoItem(16, 'A2', 7, 2, 2, 'A2.2 · Real Conversations', 'Rules, Advice and Obligations', 'Conselhos, regras e obrigações.'),
  demoItem(17, 'A2', 8, 2, 3, 'A2.2 · Real Conversations', 'Real Conversations', 'Restaurante, hotel, aeroporto e trabalho.'),
  demoItem(18, 'A2', 9, 2, 4, 'A2.2 · Real Conversations', 'A2 Final', 'Projeto final e checkpoint A2.', true),
]
...
export const demoLesson: LessonDetail = {
  ...
  levelLessonNumber: 1,
  moduleId: 1,
  moduleExternalId: 'A1-M1',
  moduleTitle: 'A1.1 · First Steps',
  moduleNumber: 1,
